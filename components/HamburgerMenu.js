...
export default function HamburgerMenu() {
  ...
  return (
    <div className='HAMBURGER-MENU fixed right-12 cursor-pointer h-14 w-14 rounded-full bg-gray-400 opacity-50 grid place-items-center z-20 hover:opacity-40 transition-opacity duration-300'>
